...
-------------------
REPORT DESCRIPTION:
This report shows all the products that have been added in the populate script. It prints all product titles, descriptions and prices of all products. 
It then adds the total of all products.
-------------------
EQUIPMENT & MATERIALS:

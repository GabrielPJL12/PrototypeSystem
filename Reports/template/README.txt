...
-------------------
RUN THE SCRIPT:
1. Edit the path on line 1 of [SCRIPT NAME] in the [FOLDER NAME] folder to the desired path of the spool file (do this using an IDE).
2. Run the [SCRIPT NAME] script using Oracle Version 11g or better through SQL*PLUS.

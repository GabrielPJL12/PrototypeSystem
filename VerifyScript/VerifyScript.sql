--Verify Script for Project Deliverable 4
set echo on
set linesize 132
set pagesize 66
...
insert into t_product (product_num, parent_category_num, supplier_num, prod_title, prod_description, prod_price, prod_weight_kg, prod_tax_exempt) 
    values(1357, 001, 00826, 'Tampax Pearl Regular Plastic Tampons, Unscented, 50 Count', 'Your flow is different everyday. Your tampon should be, too.', 12.94, 0.1, 1);
insert into t_product (product_num, parent_category_num, supplier_num, prod_title, prod_description, prod_price, prod_weight_kg, prod_tax_exempt) 
...
insert into t_product (product_num, parent_category_num, supplier_num, prod_title, prod_description, prod_price, prod_weight_kg, prod_tax_exempt) 
    values(4567, 005, 99999, 'Speaker', 'To really turn the party up to 11. Free shipping with members!', 1500, 30, 0 );
insert into t_product (product_num, parent_category_num, supplier_num, prod_title, prod_description, prod_price, prod_weight_kg, prod_tax_exempt) 
    values(6666, 007, 62385, 'Online Learning', 'Learn C# through CDW!', 100, 0.1, 1);
...
insert into t_order (order_num, customer_num, product_num, order_date, est_deliver_date, final_price, shipping_cost, tax_cost, shipping_prov) 
    values(0045, 1, 1357, '20-Feb-23', '21-Feb-23', 12.94, 0, 0, 'AB');
insert into t_order (order_num, customer_num, product_num, order_date, est_deliver_date, final_price, shipping_cost, tax_cost, shipping_prov) 
...
insert into t_order (order_num, customer_num, product_num, order_date, est_deliver_date, final_price, shipping_cost, tax_cost, shipping_prov) 
    values(123, 1, 4567, '07-Jul-21', '08-Jul-21', 1725, 0, 225 , 'PE');
...
insert into t_review (review_num, review_customer_num, review_product_num, review_price, review_weight, review_tax_exempt, review_rating, review_comments, date_created) 
    values(111, 1, 1357, 12.98, 0.1, 1, 4, 'No complaints from the wife.', '28-Feb-23');
insert into t_review (review_num, review_customer_num, review_product_num, review_price, review_weight, review_tax_exempt, review_rating, review_comments, date_created) 
